...
<div class="flex items-start justify-between mb-6 flex-wrap gap-3">
    ...
    <div class="flex items-center gap-2">
        ...
        <a href="{{ route('admin.arsip.create') }}" class="inline-flex items-center gap-2 px-4 py-2.5 text-sm font-semibold rounded-lg bg-primary text-white hover:bg-primary-light transition shadow-sm">
...
<div id="filterPanel" class="hidden bg-white rounded-xl border border-slate-200 p-5 mb-6 shadow-sm">
    <div class="flex items-center justify-between mb-4">
        ...
        <a href="{{ route('admin.arsip.index') }}" class="text-xs font-semibold text-primary hover:underline">Reset Filter</a>
    </div>
    <form method="GET" action="{{ route('admin.arsip.index') }}" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
...
<div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
    <div class="flex items-center justify-between px-5 py-4 border-b border-slate-100">
        ...
        <div class="flex items-center gap-1">
            <a href="{{ route('admin.report.arsip.excel') }}" class="p-2 rounded-lg text-slate-400 hover:bg-slate-100 hover:text-slate-600 transition" title="Export Excel">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
            </a>
            <a href="{{ route('admin.report.arsip.pdf') }}" target="_blank" class="p-2 rounded-lg text-slate-400 hover:bg-slate-100 hover:text-slate-600 transition" title="Cetak PDF">
                ...
                <tr class="hover:bg-slate-50">
                    ...
                    <td class="px-5 py-3.5">
                        <div class="flex items-center justify-end gap-1">
                            ...
                            <button type="button" onclick="confirmDelete('{{ route('admin.arsip.destroy', $arsip) }}')" class="p-1.5 rounded-md text-slate-400 hover:bg-red-50 hover:text-red-600 transition" title="Hapus"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg></button>
                        </div>
                    </td>
                </tr>
                @empty
