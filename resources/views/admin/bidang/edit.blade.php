...
@section('breadcrumb')
<a href="{{ route('admin.dashboard') }}" class="hover:text-primary">Manajemen</a> <span>/</span> <a href="{{ route('admin.bidang.index') }}" class="hover:text-primary">Daftar Bidang</a> <span>/</span> <span class="text-slate-700 font-medium">Edit Bidang</span>
@endsection
@section('content')
    ...
    <div class="lg:col-span-2 bg-white rounded-xl border border-slate-200 shadow-sm p-6">
        ...
        <form action="{{ route('admin.bidang.update', $bidang) }}" method="POST">
            ...
            <div class="flex items-center gap-3 pt-5 border-t border-slate-100">
                ...
                <a href="{{ route('admin.bidang.index') }}" class="inline-flex items-center gap-2 px-5 py-2.5 text-sm font-semibold rounded-lg border border-slate-300 text-slate-600 hover:bg-slate-50 transition">
