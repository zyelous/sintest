...
@section('breadcrumb')
<a href="{{ route('admin.dashboard') }}" class="hover:text-primary">Manajemen</a> <span>/</span> <span class="text-slate-700 font-medium">Daftar Bidang</span>
@endsection
@section('content')
...
<form method="GET" action="{{ route('admin.bidang.index') }}" class="mb-6">
