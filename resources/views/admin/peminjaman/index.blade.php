...
<div class="bg-white rounded-xl border border-slate-200 shadow-sm p-4 mb-6">
    <form method="GET" action="{{ route('admin.peminjaman.index') }}" class="flex flex-wrap xl:flex-nowrap items-end gap-3">
        ...
        <div class="w-full sm:w-40 shrink-0">
            ...
            <select name="bidang_id" class="w-full px-3 py-2 rounded-lg border-slate-300 text-xs focus:ring-primary focus:border-primary">
        ...
        <div class="flex items-center gap-2 shrink-0">
            ...
            <a href="{{ route('admin.peminjaman.index') }}" class="inline-flex items-center justify-center px-3 py-2 rounded-lg border border-slate-300 text-slate-500 hover:bg-slate-50 transition text-xs font-semibold" title="Reset">
                Reset
            </a>
            @endif
        </div>
