            ...
            <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-5">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <textarea name="tingkat_perkembangan" rows="2" placeholder="Diarsipkan di Unit Pengolah Kearsipan Bappeda" class="w-full rounded-lg border-slate-300 text-sm text-slate-500 focus:ring-primary focus:border-primary">{{ old('tingkat_perkembangan') }}</textarea>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" name="no_boks" value="{{ old('no_boks') }}" placeholder="BKS-2023-001" class="w-full rounded-lg border-slate-300 text-sm focus:ring-primary focus:border-primary">
                    ...
                    <div>
                        ...
                        <input type="text" name="no_folder" value="{{ old('no_folder', 1) }}" class="w-full rounded-lg border-slate-300 text-sm focus:ring-primary focus:border-primary">
                    </div>
