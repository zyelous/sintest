...
<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
    ...
    <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-5">
        <p class="text-[0.7rem] font-semibold text-slate-400 uppercase tracking-wide">Arsip Diarsipkan</p>
        <p class="text-3xl font-bold text-primary mt-1">{{ number_format($totalArsipTahunIni) }}</p>
