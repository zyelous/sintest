...
<div class="flex items-start justify-between mb-6 flex-wrap gap-3">
    ...
    <div class="flex items-center gap-2">
        <a href="{{ route('arsip.index') }}" class="inline-flex items-center gap-2 px-4 py-2.5 text-sm font-semibold rounded-lg border border-slate-300 bg-white text-slate-700 hover:bg-slate-50 transition shadow-sm">
        ...
        <a href="{{ route('arsip.edit', $arsip) }}" class="inline-flex items-center gap-2 px-4 py-2.5 text-sm font-semibold rounded-lg bg-accent-gold text-primary-dark hover:bg-accent-gold-dark transition shadow-sm">
        ...
        @if($arsip->file_arsip)
        <a href="{{ route('arsip.download', $arsip) }}" class="inline-flex items-center gap-2 px-4 py-2.5 text-sm font-semibold rounded-lg bg-primary text-white hover:bg-primary-light transition shadow-sm">
