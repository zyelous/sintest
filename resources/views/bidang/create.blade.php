...
@section('breadcrumb')
    ...
    <span class="text-slate-300">/</span>
    <span class="text-slate-800 font-semibold">Tambah Bidang</span>
@endsection

@section('content')
    {{-- Page Header --}}
    <div class="flex items-center justify-between mb-6 flex-wrap gap-3">
        <h1 class="text-2xl font-bold text-slate-800">Tambah Bidang</h1>
    </div>

    {{-- Card --}}
    <div class="bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden">
        <div class="flex items-center justify-between px-6 py-4 border-b border-slate-100">
            <h2 class="text-base font-semibold text-slate-700">Formulir Tambah Bidang</h2>
        </div>
