        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div class="sm:col-span-2">
                ...
                <div class="rounded-xl border border-slate-200 bg-slate-50 p-3 inline-block">
                    <img src="{{ $peminjaman->paraf_petugas }}" alt="Paraf petugas" class="h-20 bg-white rounded">
                </div>
...
<div class="sm:col-span-2 bg-emerald-50 border border-emerald-200 rounded-lg p-4">
...
<div class="sm:col-span-2 bg-sky-50 border border-sky-200 rounded-lg p-4">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.getElementById('editForm').addEventListener('submit', function () {
            // Kosong = tidak diubah, controller akan pertahankan paraf lama kalau field ini kosong.
            if (!sigPads['sigPeminjam'].isEmpty()) {
