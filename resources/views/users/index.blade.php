                            ...
                            <tr class="hover:bg-slate-50/60 transition">
                                ...
                                <td class="td-sintara text-center">
                                    <div class="inline-flex items-center gap-1">
                                        <form method="POST" action="{{ route('users.reset-password', $user->id) }}" class="inline" onsubmit="return confirm('Apakah Anda yakin ingin mereset password {{ $user->name }} ke \'password123\'?')">
                                            @csrf
                                            @method('PUT')
                                            <button type="submit"
